...
function createMenuItem(name, price, category) {
  return {
    // ! How does JS know that 'name', 'price', and 'category' on the left side are 'keys' and not 'values'?
    name: name,
    price: price,
    category: category,
  }
...
console.log(createMenuItem('Berry Blast', 3.49, 'Smoothie'))
...
reviews.push({
  name: 'Marvin',
  rating: 2,
  feedback: "I don't like these establishments",
})
